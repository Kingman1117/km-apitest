"""
用例 ID: 1150695810001062379
用例名称: H5端正常提交视频课程订单并管理后台退款
...
def test_h5_order_video_and_refund(h5_client, admin_client):
    """H5端视频订单 - 下单→查单→退款完整流程"""

    # Arrange: 获取测试数据
    test_data = TestDataManager.get_service_data("video", "h5")
