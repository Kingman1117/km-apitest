"""
用例 ID: 1150695810001062411
用例名称: EduPC端正常访问音频，提交音频订单并管理后台退款
...
def test_edupc_order_audio_and_refund(edupc_client, admin_client):
    """EduPC端音频订单 - 下单→查单→退款完整流程"""

    # Arrange: 获取测试数据
    test_data = TestDataManager.get_service_data("audio", "edupc")
